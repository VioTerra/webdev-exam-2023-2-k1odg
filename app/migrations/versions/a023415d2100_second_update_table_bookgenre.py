"""Second update table BookGenre

Revision ID: a023415d2100
Revises: 01d22f9a66a2
Create Date: 2023-06-21 00:32:30.382689
...
revision = 'a023415d2100'
down_revision = '01d22f9a66a2'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['book_id'], ['books.id'], name='fk_book_genre_book_id_books'),
    sa.ForeignKeyConstraint(['genre_id'], ['genres.id'], name='fk_book_genre_genre_id_genres'),
